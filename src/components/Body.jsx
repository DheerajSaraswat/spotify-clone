...
export default function Body({ headerBackground }) {
  const [{ token, playlistInfo, selectedPlaylistId }, dispatch] =
    useStateProvider();
  ...
  useEffect(() => {
    const getInitialPlaylist = async () => {
      ...
      dispatch({ type: reducerCases.SET_PLAYLIST, playlistInfo });
    };
    getInitialPlaylist();
      ...
      {playlistInfo && (
        <>
          <div className="playlist">
            <div className="image">
              <img src={playlistInfo.image} alt="selected playlist" />
            </div>
